# BharatYatra AI — Smarter Journeys Across India

BharatYatra AI is an intelligent travel assistant designed to simplify and enhance travel experiences across India. The platform leverages Artificial Intelligence and data-driven recommendations to help travelers discover destinations, create personalized itineraries, explore local attractions, and make informed travel decisions.
